...
function displayGrid() {
	...
	if(population < 50) {
	fill(255, 255, 255, 150); // con el tercer numero ponemos el tipo de anmiacion, 0 = organo, 150 = retardo, 255 = normal
	...
	if(population > 50) {
		...
		//fill(121, 222, 255); // color de los cuadrados
		//fill(197, 43, 22); // color de los cuadrados
		fill(178, 134, 255); // color de los cuadrados
...
function cartel() {
	...
	text(u, 110, -70, 200, 300); // Posicion texto + caja
